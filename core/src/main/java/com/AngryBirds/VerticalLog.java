...
public class VerticalLog extends Main implements Screen,Materials {
    ...
    public VerticalLog(Main game,float x,float y,float width,float height,World world,OrthographicCamera camera) {
        this.game = game;
        this.camera = camera;
