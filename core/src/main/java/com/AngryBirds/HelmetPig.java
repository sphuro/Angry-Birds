...
public class HelmetPig extends Main implements Screen,Materials {
    ...
    public HelmetPig(Main game, float x, float y, float width, float height, World world, OrthographicCamera camera) {
        this.game = game;
        this.camera = camera;
        ...
        log = new Texture("helmetpig.png");
        logb = new Texture("helmetpigb.png");
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
